...
<!--<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl">-->
  ...
  <xsl:template match="/">
    <xsl:text>ZAGS#CodeZAGS#OKATO#np#Pos#Acts#0#1#2#3#4#5#6#7#9#10#10TERSON#11#12#13#14#15#16#17#18#19#19TERSON#20#21#22#23#24#25#26#38#39#40#41#42#43&#xA;</xsl:text>
  ...
  <xsl:template match="report">
    ...
    <xsl:value-of select="sections/section/row[@code='0']/col"/><xsl:text>#</xsl:text><!--[] дата регистрации-->
    ...
    <xsl:value-of select="sections/section/row[@code='3']/col"/><xsl:text>#</xsl:text><!--[] дата рождения мужа-->
    <xsl:value-of select="sections/section/row[@code='4']/col"/><xsl:text>#</xsl:text><!--[] месяц рождения мужа-->
    <xsl:value-of select="sections/section/row[@code='5']/col"/><xsl:text>#</xsl:text><!--[] год рождения мужа-->
    <xsl:value-of select="sections/section/row[@code='6']/col"/><xsl:text>#</xsl:text><!--[] номер брака мужа-->
    <xsl:value-of select="sections/section/row[@code='7']/col"/><xsl:text>#</xsl:text><!--[] код гражданство мужа-->
    <xsl:value-of select="sections/section/row[@code='9']/col"/><xsl:text>#</xsl:text><!--[] код субъекта РФ мужа-->
    <xsl:value-of select="sections/section/row[@code='10']/col"/><xsl:text>#</xsl:text><!--[] место проживания мужа-->
    <xsl:value-of select="user:Name2Terson(sections/section/row[@code='10']/col)"/><xsl:text>#</xsl:text><!--[] ТЕРСОН проживания мужа-->
    <xsl:value-of select="sections/section/row[@code='11']/col"/><xsl:text>#</xsl:text><!--[] национальность мужа-->
    <xsl:value-of select="sections/section/row[@code='12']/col"/><xsl:text>#</xsl:text><!--[] дата рождения жены-->
    <xsl:value-of select="sections/section/row[@code='13']/col"/><xsl:text>#</xsl:text><!--[] месяц рождения жены-->
    <xsl:value-of select="sections/section/row[@code='14']/col"/><xsl:text>#</xsl:text><!--[] год рождения жены-->
    <xsl:value-of select="sections/section/row[@code='15']/col"/><xsl:text>#</xsl:text><!--[] номер брака жены-->
    <xsl:value-of select="sections/section/row[@code='16']/col"/><xsl:text>#</xsl:text><!--[] код гражданство жены-->
    <xsl:value-of select="sections/section/row[@code='17']/col"/><xsl:text>#</xsl:text><!--[] национальность жены-->
    <xsl:value-of select="sections/section/row[@code='18']/col"/><xsl:text>#</xsl:text><!--[] код субъекта РФ жены-->
    <xsl:value-of select="sections/section/row[@code='19']/col"/><xsl:text>#</xsl:text><!--[] место проживания жены-->
    <xsl:value-of select="user:Name2Terson(sections/section/row[@code='19']/col)"/><xsl:text>#</xsl:text><!--[] ТЕРСОН проживания жены-->
    <xsl:value-of select="sections/section/row[@code='20']/col"/><xsl:text>#</xsl:text><!--[] количество общих детей-->
    <xsl:value-of select="sections/section/row[@code='21']/col"/><xsl:text>#</xsl:text><!--[] день регистрации брака-->
    <xsl:value-of select="sections/section/row[@code='22']/col"/><xsl:text>#</xsl:text><!--[] месяц регистрации брака-->
    <xsl:value-of select="sections/section/row[@code='23']/col"/><xsl:text>#</xsl:text><!--[] год регистрации брака-->
    <xsl:value-of select="sections/section/row[@code='24']/col"/><xsl:text>#</xsl:text><!--[] день прекращения брака-->
    <xsl:value-of select="sections/section/row[@code='25']/col"/><xsl:text>#</xsl:text><!--[] месяц прекращения брака-->
    <xsl:value-of select="sections/section/row[@code='26']/col"/><xsl:text>#</xsl:text><!--[] год прекращения брака-->
    <xsl:value-of select="sections/section/row[@code='38']/col"/><xsl:text>#</xsl:text><!--[] возраст мужа-->
    <xsl:value-of select="sections/section/row[@code='39']/col"/><xsl:text>#</xsl:text><!--[] возраст жены-->
    <xsl:value-of select="sections/section/row[@code='40']/col"/><xsl:text>#</xsl:text><!--[] место рождения мужа-->
    <xsl:value-of select="sections/section/row[@code='41']/col"/><xsl:text>#</xsl:text><!--[] место рождения жены-->
    <xsl:value-of select="sections/section/row[@code='42']/col"/><xsl:text>#</xsl:text><!--[] образование мужа-->
    <xsl:value-of select="sections/section/row[@code='43']/col"/><xsl:text>&#xA;</xsl:text><!--[] образование жены-->
  </xsl:template>
</xsl:stylesheet>
